...
class M3GLVQ_Global(BaseEstimator, ClassifierMixin):
    ...
    def fit(self, DL, y):
        ...
        # per-class sizes; we use a deterministic medoid scheme instead: pick the
        # point with minimal summed squared distance, then farthest-point-seed
        # the remaining k-1 medoids.
